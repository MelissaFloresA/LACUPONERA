...
<body>
        ...
        <div class="row h-100 align-items-center">
            ...
            <div class="col-md-6">
                <div class="card text-white p-4">
                    ...
                    <div class="card-body">
                    <form action="/LACUPONERA/recuperar-contrasena/actualizar" method="POST">
                            <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="/LACUPONERA/login" class="link-offset-3 link-underline-light text-white link-underline-opacity-0 link-underline-opacity-100-hover">Volver a Iniciar Sesión</a>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <div class="toast-container position-fixed top-0 end-0 p-3">
        <div id="toast" class="toast align-items-center <?= isset($_SESSION['Result']['status']) && $_SESSION['Result']['status'] ? 'text-bg-success' : 'text-bg-danger' ?> border-0" role="alert" aria-live="assertive" aria-atomic="true">
            <div class="d-flex">
                <div class="toast-body">
                    <?php echo isset($_SESSION['Result']['mensaje']) ? htmlspecialchars($_SESSION['Result']['mensaje']) : ''; ?>
                </div>
